...
class CustomSocketBlueprint(Blueprint):
...
class CustomSocketIOOutput(OutputChannel):
    @classmethod
    def name(cls) -> Text:
        return "mysocket"
...
class CustomSocketIOInput(InputChannel):
    ...
    def get_output_channel(self) -> Optional["OutputChannel"]:
        if self.sio is None:
            ...
            return
        return CustomSocketIOOutput(self.sio, self.bot_message_evt)
    ...
    def blueprint(
        ...
        socketio_webhook = CustomSocketBlueprint(
